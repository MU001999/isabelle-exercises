...
next
  ...
  hence "xs = ?l1 @ ?l2 ∧ length ?l1 = length ?l2 + 1" by (smt add.commute add_diff_cancel_right' append_take_drop_id left_add_twice length_append length_drop odd_two_times_div_two_succ)
  thus ?thesis by blast
qed
